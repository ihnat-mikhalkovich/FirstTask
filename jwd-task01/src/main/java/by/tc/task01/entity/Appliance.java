...
public class Appliance {
    ...
    private ArrayList<String> appliance = new ArrayList<String>();
    ...
    public void put(String[] fieldsOfAppliance){
        ...
        for (int i = firstCriteria; i < fieldsOfAppliance.length; i++){
            if (ApplianceFieldsValidator.verifyCriteriaField(fieldsOfAppliance[i])) {
                appliance.add(fieldsOfAppliance[i]);
            }
        }
    }
